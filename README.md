...
* [Ver Documento](references/Sistema-Experto-Construccion---Evaluacion-Parcial---Suarez-Jonatan.pdf)
...
│                         construccion_experto and configuration for tools like black
│
...
│
└── construccion_experto   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes construccion_experto a Python module
    │
